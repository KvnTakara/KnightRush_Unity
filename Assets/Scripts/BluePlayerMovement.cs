...
public class BluePlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        #region Score Text
        scoreText.text = GameManager.instance.scoreBlue.ToString();
        #endregion

        #region Instantiate Blockers
        if (Input.GetKey(KeyCode.RightShift) && GameManager.instance.maxBlockers > GameManager.instance.activeBlueBlockers)
        {
    ...
    private void FixedUpdate()
    {
        ...
        rb.velocity = new Vector2(Input.GetAxis("Horizontal-P2") * moveSpeed, Input.GetAxis("Vertical-P2") * moveSpeed);
        #endregion
    ...
    {
        if (collision.gameObject.tag == "BlueBlocker")
        {
